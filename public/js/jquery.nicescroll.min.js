!(function (e) {
    ...
    function l(e, o) {
        ...
        if (
            ...
            (this.ispage = /^BODY|HTML/.test(
                x.win ? x.win[0].nodeName : this.doc[0].nodeName
            )),
        ...
        if (
            ...
            (this.observerbody = !1) !== x.scrollbarid)
        )
            this.id = x.scrollbarid;
        ...
        (this.rail = !1),
            ...
            (this.detected = (function () {
                ...
                return (
                    (n.haspointerlock =
                        "pointerLockElement" in R ||
                        "webkitPointerLockElement" in R ||
                        "mozPointerLockElement" in R),
                    (n.isopera = "opera" in _),
                    (n.isopera12 = n.isopera && "getUserMedia" in navigator),
                    (n.isoperamini =
                        "[object OperaMini]" ===
                        Object.prototype.toString.call(_.operamini)),
                    (n.isie = "all" in R && "attachEvent" in e && !n.isopera),
                    (n.isieold = n.isie && !("msInterpolationMode" in s)),
                    (n.isie7 =
                        n.isie &&
                        !n.isieold &&
                        (!("documentMode" in R) || 7 === R.documentMode)),
                    (n.isie8 =
                        n.isie && "documentMode" in R && 8 === R.documentMode),
                    (n.isie9 =
                        n.isie && "performance" in _ && 9 === R.documentMode),
                    (n.isie10 =
                        n.isie && "performance" in _ && 10 === R.documentMode),
                    (n.isie11 =
                        "msRequestFullscreen" in e && 11 <= R.documentMode),
                    ...
                    (n.ischrome22 =
                        !n.ischrome38 && n.ischrome && n.haspointerlock),
                    (n.ischrome26 =
                        !n.ischrome38 && n.ischrome && "transition" in s),
                    (n.cantouch =
                    ...
                    n.hastransform &&
                        ((s[n.trstyle] = "translate3d(1px,2px,3px)"),
                        (n.hastranslate3d = /translate3d/.test(s[n.trstyle]))),
                    ...
                    (n.hastransition =
                        ...
                        (function () {
                            ...
                            n.ischrome26 && (n.prefixstyle = o[1]),
        ...
        if (
            ...
            this.isrtlmode
                ? this.isvertical
                    ? (this.hasreversehr = !(S.iswebkit || S.isie || S.isie11))
                    : (this.hasreversehr = !(
                          S.iswebkit ||
                          (S.isie && !S.isie10 && !S.isie11)
                      ))
                : (this.hasreversehr = !1),
            (this.istouchcapable = !1),
            ((S.cantouch || (!S.hasw3ctouch && !S.hasmstouch)) &&
                (!S.cantouch ||
                    S.isios ||
                    S.isandroid ||
                    (!S.iswebkit && !S.ismozilla))) ||
                (this.istouchcapable = !0),
            x.enablemouselockapi ||
            ...
            (this.synched = function (e, o) {
                b.synclist[e]
                    ...
                    : ((b.synclist[e] = o),
                      Y(function () {
                          b &&
                              (b.synclist[e] && b.synclist[e].call(b),
                              (b.synclist[e] = null));
                      }));
            }),
            ...
            (this.css = function (e, o) {
                for (var t in o)
                    b.saved.css.push([e, t, e.css(t)]), e.css(t, o[t]);
            }),
            ...
            S.hastranslate3d && x.enabletranslate3d
                ? ((this.setScrollTop = function (e, o) {
                      (b.doc.translate.y = e),
                          ...
                          o || b.notifyScrollEvent(b.win[0]);
                  }),
                  (this.setScrollLeft = function (e, o) {
                      (b.doc.translate.x = e),
                          (b.doc.translate.tx = e * n + "px"),
                          b.doc.css(
                              S.trstyle,
                              "translate3d(" +
                                  b.doc.translate.tx +
            ...
            (this.getScrollTop = function () {
                ...
                (this.getScrollLeft = function () {
                    return b.hasreversehr
                        ? b.detected.ismozilla
                            ? b.page.maxw - Math.abs(b.docscroll.scrollLeft())
                            : b.page.maxw - b.docscroll.scrollLeft()
                        : b.docscroll.scrollLeft();
                }),
                (this.setScrollLeft = function (e) {
                    return setTimeout(function () {
                        if (b)
                            return (
                                b.hasreversehr &&
                                    (e = b.detected.ismozilla
                                        ? -(b.page.maxw - e)
                                        : b.page.maxw - e),
                                b.docscroll.scrollLeft(e)
                            );
                    }, 1);
                });
        (this.getTarget = function (e) {
            return (
                !!e && (e.target ? e.target : !!e.srcElement && e.srcElement)
            );
        }),
        ...
        (this.getDocumentScrollOffset = function () {
            ...
            (this.updateScrollBar = function (e) {
                ...
                if (b.ishwscroll)
                    b.rail.css({
                        height:
                            b.win.innerHeight() -
                            (x.railpadding.top + x.railpadding.bottom),
                    }),
                        b.railh &&
                            b.railh.css({
                                width:
                                    b.win.innerWidth() -
                                    (x.railpadding.left + x.railpadding.right),
                            });
                else {
                    var r = b.getOffset();
                    if (
                        (((o = {
                            ...
                            left:
                                r.left -
                                (x.railpadding.left + x.railpadding.right),
                        }).top += a(b.win, "border-top-width", !0)),
                        (o.left += b.rail.align
                            ? b.win.outerWidth() -
                              a(b.win, "border-right-width") -
                              b.rail.width
                            : a(b.win, "border-left-width")),
                        (t = x.railoffset) &&
                            (t.top && (o.top += t.top),
                        ...
                        var i = b.railh.align
                                ? o.top +
                                  a(b.win, "border-top-width", !0) +
                                  b.win.innerHeight() -
                                  b.railh.height
                                : o.top + a(b.win, "border-top-width", !0),
            ...
            (this.doRailClick = function (e, o, t) {
                ...
                b.railslocked ||
                    (b.cancelEvent(e),
                    "pageY" in e ||
                        ((e.pageX = e.clientX + R.documentElement.scrollLeft),
                        (e.pageY = e.clientY + R.documentElement.scrollTop)),
                    o
                        ? ((r = t ? b.doScrollLeft : b.doScrollTop),
                          ...
                          r(0 | s))
                        : ((r = t ? b.doScrollLeftBy : b.doScrollBy),
                          (s = t ? b.scroll.x : b.scroll.y),
                          (n = t
                              ? e.pageX - b.railh.offset().left
                              : e.pageY - b.rail.offset().top),
                          (i = t ? b.view.w : b.view.h),
                          r(n <= s ? i : -i)));
            }),
            ...
            (this.init = function () {
                ...
                (x.emulatetouch = x.emulatetouch || x.touchbehavior),
                    (b.hasborderbox =
                        _.getComputedStyle &&
                        "border-box" ===
                            _.getComputedStyle(R.body)["box-sizing"]);
                var t = { "overflow-y": "hidden" };
                if (
                    ((S.isie11 || S.isie10) &&
                        (t["-ms-overflow-style"] = "none"),
                    b.ishwscroll &&
                        (this.doc.css(
                            S.transitionstyle,
                            S.prefixstyle + "transform 0ms ease-out"
                        ),
                        S.transitionend &&
                            b.bind(
                                b.doc,
                    ...
                    b.ispage && (e = b.haswrapper ? b.win : b.doc),
                        b.css(e, t),
                        b.ispage && (S.isie11 || S.isie) && b.css(P("html"), t),
                        !S.isios ||
                            b.ispage ||
                            b.haswrapper ||
                            b.css(y, { "-webkit-overflow-scrolling": "touch" });
                    ...
                    r.attr("id", b.id),
                        ...
                        x.scrollCLass && r.addClass(x.scrollCLass);
                    var i,
                        s,
                    ...
                    for (var l in n)
                        (s = n[l]),
                            (i = x.railpadding[s] || 0) &&
                                r.css("padding-" + s, i + "px");
                    r.append(o),
                        (r.width = Math.max(
                            parseFloat(x.cursorwidth),
                            o.outerWidth()
                        )),
                        r.css({
                            width: r.width + "px",
                    ...
                    if (
                        (!x.boxzoom ||
                            ...
                            b.zoom.css({
                                ...
                                zIndex: b.zindex,
                                backgroundImage:
                                    "url(" + x.scriptpath + "zoomico.png)",
                                height: 18,
                                width: 18,
                                backgroundPosition: "0 0",
                            }),
                            x.dblclickzoom &&
                                b.bind(b.win, "dblclick", b.doZoom),
                            S.cantouch &&
                                x.gesturezoom &&
                                ((b.ongesturezoom = function (e) {
                                    return (
                                        1.5 < e.scale && b.doZoomIn(e),
                                        e.scale < 0.8 && b.doZoomOut(e),
                                        b.cancelEvent(e)
                                    );
                                }),
                        ...
                        if (b.ishwscroll) {
                            ...
                            var d =
                                "HTML" == b.win[0].nodeName ? b.body : b.win;
                            ...
                            b.isfixed || (b.viewport = b.getViewport(b.win[0])),
                                ...
                                b.railh &&
                                    (a.css({ position: u }), b.body.append(a));
                        }
                        S.isios &&
                            b.css(b.win, {
                            ...
                            x.disableoutline &&
                                (S.isie && b.win.attr("hideFocus", "true"),
                                S.iswebkit && b.win.css("outline", "none"));
                    }
                    if (
                        (!1 === x.autohidemode
                            ? ((b.autohidedom = !1),
                              b.rail.css({ opacity: x.cursoropacitymax }),
                              b.railh &&
                                  b.railh.css({ opacity: x.cursoropacitymax }))
                            : !0 === x.autohidemode ||
                              "leave" === x.autohidemode
                            ? ((b.autohidedom = P().add(b.rail)),
                              S.isie8 &&
                                  (b.autohidedom = b.autohidedom.add(b.cursor)),
                              b.railh &&
                            ...
                            ? ((b.autohidedom = P().add(b.cursor)),
                              b.railh &&
                                  (b.autohidedom = b.autohidedom.add(
                                      b.cursorh
                                  )))
                            : "hidden" == x.autohidemode &&
                              ((b.autohidedom = !1),
                              b.hide(),
                              (b.railslocked = !1)),
                        S.cantouch ||
                        ...
                        (b.ontouchstart = function (e) {
                            ...
                            if (
                                ((b.hasmoving = !1),
                                b.scrollmom.timer &&
                                    (b.triggerScrollEnd(), b.scrollmom.stop()),
                                !b.railslocked)
                            ) {
                                var o = b.getTarget(e);
                                if (o)
                                ...
                                if (
                                    ...
                                    b.ispage || !x.directionlockdeadzone)
                                )
                                    b.rail.drag.dl = "f";
                                else {
                                    var i = I.width(),
                                    ...
                                    b.rail.scrollable && !b.railh.scrollable
                                        ? (b.rail.drag.ck = 0 < l && "v")
                                        : !b.rail.scrollable &&
                                          b.railh.scrollable
                                        ? (b.rail.drag.ck = 0 < a && "h")
                                        : (b.rail.drag.ck = !1);
                                }
                                if (x.emulatetouch && b.isiframe && S.isie) {
                                    var c = b.win.position();
                                    (b.rail.drag.x += c.left),
                                        (b.rail.drag.y += c.top);
                                }
                                if (
                                    ((b.hasmoving = !1),
                                    (b.lastmouseup = !1),
                                    b.scrollmom.reset(e.clientX, e.clientY),
                                    o && t)
                                ) {
                                    if (
                        ...
                        (b.ontouchmove = function (e, o) {
                            ...
                            var s = e.clientY + t,
                                ...
                                a = l - b.rail.drag.x,
                                c = b.rail.drag.st - n;
                            if (b.ishwscroll && x.bouncescroll)
                                c < 0
                                    ? (c = Math.round(c / 2))
                                    : c > b.page.maxh &&
                                      (c =
                                          b.page.maxh +
                                          Math.round((c - b.page.maxh) / 2));
                            else if (
                                (c < 0
                                    ? (s = c = 0)
                                    : c > b.page.maxh &&
                                ...
                                return b.ispage || (b.rail.drag = !1), !0;
                            ...
                            if (
                                ...
                                if (
                                    b.rail.drag.y === e.clientY &&
                                    b.rail.drag.x === e.clientX
                                )
                                    return b.cancelEvent(e);
                                var u = Math.abs(n),
                                    h = Math.abs(a),
                                ...
                                if (
                                    (b.rail.drag.ck
                                        ...
                                        : p < h &&
                                          (b.rail.drag.dl = f < u ? "f" : "h"),
                                    !b.rail.drag.dl)
                                )
                                    return b.cancelEvent(e);
                                b.triggerScrollStart(
                                    e.clientX,
                                    e.clientY,
                                    0,
                                    0,
                            ...
                            return (
                                b.preventclick &&
                                    ...
                                    ((b.preventclick.click =
                                        b.preventclick.tg.onclick || !1),
                                    (b.preventclick.tg.onclick =
                                        b.onpreventclick)),
                                b.rail.drag.dl &&
                                    ("v" == b.rail.drag.dl
                                        ? (d = b.rail.drag.sl)
                            ...
                            (b.ontouchmoveCursor = function (e) {
                                if (b.rail.drag) {
                                    ...
                                    if (
                                        ((b.cursorfreezed = !0), b.rail.drag.hr)
                                    ) {
                                        (b.scroll.x =
                                            b.rail.drag.sx +
                                            (e.touches[0].clientX -
                        ...
                        (b.onpreventclick = function (e) {
                            ...
                            (b.onclick =
                                ...
                                function (e) {
                                    return (
                                        !b.lastmouseup ||
                                        ((b.lastmouseup = !1), b.cancelEvent(e))
                                    );
                                }),
                            x.grabcursorenabled &&
                                S.cursorgrabvalue &&
                                ...
                                b.css(b.rail, { cursor: S.cursorgrabvalue }));
                    else {
                        var h = function (e) {
                            if (b.selectiondrag) {
                                if (e) {
                    ...
                    if (
                        (S.hasw3ctouch
                            ...
                            : S.cantouch &&
                              ...
                              b.bind(R, "touchend", b.ontouchend, !1, !0),
                              b.bind(R, "touchcancel", b.ontouchend, !1, !0),
                              b.delegate(
                                  R,
                                  "touchmove",
                                  b.ontouchmove,
                        ...
                        x.emulatetouch &&
                            (b.bind(b.win, "mousedown", b.ontouchstart, !1, !0),
                            b.bind(R, "mouseup", b.ontouchend, !1, !0),
                            b.bind(R, "mousemove", b.ontouchmove, !1, !0)),
                        (!x.cursordragontouch &&
                            (S.cantouch || x.emulatetouch)) ||
                        ...
                        x.enablemousewheel &&
                            (b.isiframe ||
                                b.mousewheel(
                                    S.isie && b.ispage ? R : b.win,
                                    b.onmousewheel
                                ),
                            b.mousewheel(b.rail, b.onmousewheel),
                            b.railh && b.mousewheel(b.railh, b.onmousewheelhr)),
                        b.ispage ||
                            S.cantouch ||
                            /HTML|^BODY/.test(b.win[0].nodeName) ||
                            (b.win.attr("tabindex") ||
                                b.win.attr({ tabindex: ++M }),
                            b.bind(b.win, "focus", function (e) {
                                (E = b.getTarget(e).id || b.getTarget(e) || !1),
                                    (b.hasfocus = !0),
                            ...
                            b.bind(b.win, "mouseenter", function (e) {
                                (L = b.getTarget(e).id || b.getTarget(e) || !1),
                                    (b.hasmousefocus = !0),
                                    b.canshowonmouseevent && b.noticeCursor();
                            }),
                            ...
                            (b.isie11 ||
                                ...
                                ((b.observerbody = new B(function (e) {
                                    if (
                                        ...
                                        b.me.clientWidth != b.page.width ||
                                            b.me.clientHeight != b.page.height)
                                    )
                    ...
                    !b.ispage && x.boxzoom && b.bind(_, "resize", b.resizeZoom),
                        b.istextarea &&
                            (b.bind(b.win, "keydown", b.lazyResize),
                            b.bind(b.win, "mouseup", b.lazyResize)),
                        b.lazyResize(30);
                }
                    ...
                    var w = function () {
                        ...
                        b.lazyResize(30),
                            ...
                            "contentWindow" in this
                                ...
                                : b.bind(o, "scroll", b.onscroll),
                            x.enablemousewheel &&
                                b.mousewheel(o, b.onmousewheel),
                            x.enablekeyboard &&
                                b.bind(
                                    o,
                                    S.isopera ? "keypress" : "keydown",
                                    b.onkeypress
                                ),
                            S.cantouch
                                ? (b.bind(o, "touchstart", b.ontouchstart),
                                  b.bind(o, "touchmove", b.ontouchmove))
                                : x.emulatetouch &&
                            ...
                            b.zoom &&
                                (x.dblclickzoom &&
                                    b.bind(o, "dblclick", b.doZoom),
                                b.ongesturezoom &&
                                    b.bind(o, "gestureend", b.ongesturezoom));
                    };
                ...
                if (
                    ...
                    if (
                        (b.autohidedom &&
                            (b.autohidedom
                                .stop()
                                .css({ opacity: x.cursoropacitymax }),
                            (b.cursoractive = !0)),
                        (b.rail.drag && 1 == b.rail.drag.pt) ||
                            (void 0 !== e &&
                                !1 !== e &&
                                (b.scroll.y = (e / b.scrollratio.y) | 0),
                            void 0 !== o &&
                                (b.scroll.x = (o / b.scrollratio.x) | 0)),
                        b.cursor.css({
                        ...
                        var t = b.hasreversehr
                            ? b.scrollvaluemaxw - b.scroll.x
                            : b.scroll.x;
                        b.cursorh.css({
                            width: b.cursorwidth,
                            left:
                    ...
                    b.zoom &&
                        b.zoom.stop().css({ opacity: x.cursoropacitymax });
                }
            }),
                    ...
                    (b.rail &&
                        ...
                        ((b.hasmousefocus && "leave" === x.autohidemode) ||
                            (b.cursortimeout = setTimeout(function () {
                                (b.rail.active && b.showonmouseevent) ||
                                    (b.autohidedom
                                        .stop()
                                        .animate({
            ...
            (this.onResize = function (e, o) {
                ...
                return (
                    ...
                    0 === b.page.maxw
                        ...
                        : ((b.page.maxw -=
                              x.railpadding.left + x.railpadding.right),
                          b.railh && (b.railh.scrollable = x.horizrailenabled)),
                    (b.railslocked =
                        b.locked || (0 === b.page.maxh && 0 === b.page.maxw)),
                    b.railslocked
                        ? (b.ispage || b.updateScrollBar(b.view), !1)
                        : (b.hidden ||
                              (b.rail.visibility || b.showRail(),
                              b.railh && !b.railh.visibility && b.showRailHr()),
                          b.istextarea &&
                              b.win.css("resize") &&
                          ...
                          (b.cursorheight = x.cursorfixedheight
                              ? x.cursorfixedheight
                              : Math.max(x.cursorminheight, b.cursorheight)),
                          (b.cursorwidth = Math.min(
                              b.view.w,
                              Math.round(b.view.w * (b.view.w / b.page.w))
                          )),
                          (b.cursorwidth = x.cursorfixedheight
                              ? x.cursorfixedheight
                              : Math.max(x.cursorminheight, b.cursorwidth)),
                          (b.scrollvaluemax =
                              b.view.h -
                              b.cursorheight -
                              (x.railpadding.top + x.railpadding.bottom)),
                          b.hasborderbox ||
                              (b.scrollvaluemax -=
                                  b.cursor[0].offsetHeight -
                                  b.cursor[0].clientHeight),
                          b.railh &&
                              ((b.railh.width =
                                  0 < b.page.maxh
                                      ? b.view.w - b.rail.width
                                      : b.view.w),
                              (b.scrollvaluemaxw =
                                  b.railh.width -
                                  b.cursorwidth -
                          ...
                          b.getScrollTop() > b.page.maxh
                              ...
                              : ((b.scroll.y =
                                    (b.getScrollTop() / b.scrollratio.y) | 0),
                                (b.scroll.x =
                                    (b.getScrollLeft() / b.scrollratio.x) | 0),
                                b.cursoractive && b.noticeCursor()),
                          b.scroll.y &&
                              0 === b.getScrollTop() &&
                              b.doScrollTo((b.scroll.y * b.scrollratio.y) | 0),
                          b)
                );
            }),
            ...
            b._bind(
                ...
                function (e) {
                    ...
                    return (
                        "mousewheel" == r
                            ? (e.wheelDeltaX &&
                                  (o.deltaX = -0.025 * e.wheelDeltaX),
                              e.wheelDeltaY &&
                                  (o.deltaY = -0.025 * e.wheelDeltaY),
                              o.deltaY ||
                                  o.deltaX ||
                                  (o.deltaY = -0.025 * e.wheelDelta))
                            : (o.deltaY = e.detail),
                        i.call(t, o)
                    );
                },
        ...
        var h = !(this.mousewheel = function (e, o, t) {
            ...
            if ("onwheel" in R.createElement("div"))
                b._bind(r, "wheel", o, t || !1);
            else {
                var i =
                    void 0 !== R.onmousewheel ? "mousewheel" : "DOMMouseScroll";
                u(r, i, o, t || !1),
                    "DOMMouseScroll" == i &&
                        u(r, "MozMousePixelScroll", o, t || !1);
            }
        });
        ...
        (this.delegate = function (e, o, t, r, i) {
            ...
            s ||
                ...
                (O[o] = s)),
                b.ispage
                    ? ((s.a = [b.id].concat(s.a)), (s.l = [t].concat(s.l)))
                    : (s.a.push(b.id), s.l.push(t));
        }),
            ...
            (this._bind = function (e, o, t, r, i) {
                b.events.push({ e: e, n: o, f: t, b: r, q: !1 }),
                    h &&
                    (i ||
                        e == window.document ||
            ...
            (this.showRail = function () {
                return (
                    0 === b.page.maxh ||
                        (!b.ispage && "none" == b.win.css("display")) ||
                        ((b.rail.visibility = !0),
            ...
            (this.hideRail = function () {
                return (
                    (b.rail.visibility = !1), b.rail.css("display", "none"), b
                );
            }),
            ...
            (this.remove = function () {
                ...
                b.delaylist))
                    b.delaylist[e] && H(b.delaylist[e].h);
                b.doZoomOut(),
                    b.unbindAll(),
                    S.isie9 &&
                        b.win[0].detachEvent(
            ...
            if (o) {
                if (
                    ...
                    o =
                        b.newscrolly < -n
                            ? ((b.newscrolly = -n), -1)
                            : b.newscrolly > b.page.maxh + n
                            ? ((b.newscrolly = b.page.maxh + n), 1)
                            : 0;
                }
                var l = 0 < o ? 1 : -1;
                m !== l &&
        ...
        function k(e, o, t) {
            ...
            if (!t && z) return !0;
            0 === e.deltaMode
                ? ((r = (-e.deltaX * (x.mousescrollstep / 54)) | 0),
                  (i = (-e.deltaY * (x.mousescrollstep / 54)) | 0))
                : 1 === e.deltaMode &&
                  ((r = ((-e.deltaX * x.mousescrollstep * 50) / 80) | 0),
                  (i = ((-e.deltaY * x.mousescrollstep * 50) / 80) | 0)),
                o &&
                    x.oneaxismousemode &&
                    0 === r &&
                    i &&
                    ...
                    !t ||
                        ((r < 0
                            ? b.getScrollLeft() >= b.page.maxw
                            : b.getScrollLeft() <= 0) &&
                            ((i = r), (r = 0))));
            if ((b.isrtlmode && (r = -r), !w(r, i, t, !0)))
                return (
                    (z = !1), e.stopImmediatePropagation(), e.preventDefault()
                );
            t && (z = !0);
        }
        if (
            ((this.onmousewheel = function (e) {
                ...
                if (b.railslocked)
                    return b.debounced("checkunlock", b.resize, 250), !1;
                if (b.rail.drag) return b.cancelEvent(e);
                if (
                    ("auto" === x.oneaxismousemode &&
                        0 !== e.deltaX &&
                        (x.oneaxismousemode = !1),
                    x.oneaxismousemode && 0 === e.deltaX && !b.rail.scrollable)
                )
                    return (
                        !b.railh || !b.railh.scrollable || b.onmousewheelhr(e)
                    );
                var o = X(),
                    t = !1;
                if (
                    (x.preservenativescrolling &&
                        b.checkarea + 600 < o &&
                        ((b.nativescrollingarea = b.isScrollable(e)), (t = !0)),
                    (b.checkarea = o),
                    b.nativescrollingarea)
                )
                    return !0;
                var r = k(e, !1, t);
            ...
            (this.onmousewheelhr = function (e) {
                if (!b.wheelprevented) {
                    ...
                    return (
                        x.preservenativescrolling &&
                            b.checkarea + 600 < o &&
                            ((b.nativescrollingarea = b.isScrollable(e)),
                            (t = !0)),
                        (b.checkarea = o),
                        !!b.nativescrollingarea ||
                            (b.railslocked ? b.cancelEvent(e) : k(e, !0, t))
                    );
                }
            }),
            (this.stop = function () {
            ...
            if (
                ...
                (this.resetTransition = function () {
                    (T = ""),
                        b.doc.css(S.prefixstyle + "transition-duration", "0ms");
                }),
                    (this.prepareTransition = function (e, o) {
                        ...
                        return (
                            T !== r &&
                                ((T = r),
                                b.doc.css(
                                    S.prefixstyle + "transition-duration",
                                    r
                                )),
                            t
                        );
                    ...
                    (this.doScrollPos = function (e, o, t) {
                        var r = b.getScrollTop(),
                            i = b.getScrollLeft();
                        if (
                            (((b.newscrolly - r) * (o - r) < 0 ||
                                (b.newscrollx - i) * (e - i) < 0) &&
                                b.cancelScroll(),
                            x.bouncescroll
                                ? (o < 0
                                      ? (o = (o / 2) | 0)
                                ...
                                : (o < 0
                                      ? (o = 0)
                                      : o > b.page.maxh && (o = b.page.maxh),
                                  e < 0
                                      ? (e = 0)
                                      : e > b.page.maxw && (e = b.page.maxw)),
                            b.scrollrunning &&
                                e == b.newscrollx &&
                                o == b.newscrolly)
                        )
                        ...
                        b.scrollrunning ||
                            ((b.scrollrunning = !0),
                            b.triggerScrollStart(n, s, e, o, c),
                            b.cursorupdate.start()),
                            (b.scrollendtrapped = !0),
                            S.transitionend ||
                                (b.scrollendtrapped &&
                                    clearTimeout(b.scrollendtrapped),
                                (b.scrollendtrapped = setTimeout(
                                    b.onScrollTransitionEnd,
                                    c
                                ))),
                    ...
                    (this.onScrollTransitionEnd = function () {
                        if (b.scrollendtrapped) {
                            ...
                            if (
                                (e < 0
                                    ? (e = 0)
                                    : e > b.page.maxh && (e = b.page.maxh),
                                o < 0
                                    ? (o = 0)
                                    : o > b.page.maxw && (o = b.page.maxw),
                                e != b.newscrolly || o != b.newscrollx)
                            )
                                return b.doScrollPos(o, e, x.snapbackspeed);
                ...
                (this.doScrollLeft = function (e, o) {
                    ...
                    (this.doScrollPos = function (e, o, t) {
                        ...
                        var s = !1;
                        if (
                            ((b.bouncescroll && b.rail.visibility) ||
                                (o < 0
                                    ? (s = !(o = 0))
                                    : o > b.page.maxh &&
                                      ((o = b.page.maxh), (s = !0))),
                            (b.bouncescroll && b.railh.visibility) ||
                                (e < 0
                                    ? (s = !(e = 0))
                                    : e > b.page.maxw &&
                                      ((e = b.page.maxw), (s = !0))),
                        ...
                        var n =
                                0 |
                                Math.sqrt(
                                    b.dst.x * b.dst.x + b.dst.y * b.dst.y
                                ),
                            l = b.getTransitionSpeed(n);
                        b.bzscroll = {};
                        var a = s ? 1 : 0.58;
                        (b.bzscroll.x = new d(i, b.newscrollx, l, 0, 0, a, 1)),
                            (b.bzscroll.y = new d(
                                r,
                                b.newscrolly,
                                l,
                        ...
                        var c = function () {
                            if (b.scrollrunning) {
                                ...
                                b.setScrollLeft(b.bzscroll.x.getNow()),
                                    b.setScrollTop(b.bzscroll.y.getNow()),
                                    e <= 1
                                        ? (b.timer = Y(c))
                                        : ((b.scrollrunning = !1),
                                          (b.timer = 0),
                        ...
                        b.scrollrunning ||
                            (b.triggerScrollStart(i, r, e, o, l),
                            (b.scrollrunning = !0),
                            (b.timer = Y(c)));
                    }),
                    (this.cancelScroll = function () {
        ...
        (this.doScrollBy = function (e, o) {
            ...
            (this.doScrollTo = function (e, o) {
                ...
                t < 0 ? (t = 0) : t > b.page.maxh && (t = b.page.maxh),
                    (b.cursorfreezed = !1),
                    b.doScrollTop(e);
            }),
            ...
            (b.onscroll = function (e) {
                b.rail.drag ||
                    ...
                    b.synched("scroll", function () {
                        (b.scroll.y = Math.round(
                            b.getScrollTop() / b.scrollratio.y
                        )),
                            b.railh &&
                                (b.scroll.x = Math.round(
                                    b.getScrollLeft() / b.scrollratio.x
                                )),
                            b.noticeCursor();
                    });
            }),
            ...
            (this.doZoomIn = function (e) {
                if (!b.zoomactive) {
                    ...
                    (b.zoomrestore.style.width = b.win.css("width")),
                        ...
                        S.isios4 &&
                            ((b.zoomrestore.scrollTop = I.scrollTop()),
                            I.scrollTop(0)),
                        b.win.css({
            ...
            (this.resizeZoom = function () {
                if (b.zoomactive) {
                    ...
                    b.win.css({
                        ...
                        b.onResize(),
                        b.setScrollTop(Math.min(b.page.maxh, e));
                }
            }),
            this.init(),
    ...
    var o,
        ...
        D = {
            ...
            scriptpath:
                ((t =
                    R.currentScript ||
                    (!!(o = R.getElementsByTagName("script")).length &&
                        o[o.length - 1])),
                (r = t ? t.src.split("?")[0] : ""),
                0 < r.split("/").length
        ...
        q = function (e) {
            ...
            (this.nc = e),
                ...
                (this.update = function (e, o) {
                    ...
                    (f.snapx = n < 0 || n > f.nc.page.maxw),
                        (f.snapy = s < 0 || s > f.nc.page.maxh),
                        (f.speedx = i),
                        (f.speedy = r),
                        (f.lastx = e),
                        (f.lasty = o);
                ...
                (this.doSnapy = function (e, o) {
                    ...
                    o < 0
                        ? (t = !(o = 0))
                        : o > f.nc.page.maxh &&
                          ((o = f.nc.page.maxh), (t = !0)),
                        e < 0
                            ? (t = !(e = 0))
                            : e > f.nc.page.maxw &&
                              ((e = f.nc.page.maxw), (t = !0)),
                        t
                            ? f.nc.doScrollPos(e, o, f.nc.opt.snapbackspeed)
                            : f.nc.triggerScrollEnd();
                }),
                (this.doMomentum = function (e) {
                    var o = X(),
                        ...
                        s = f.nc.page.maxh,
                        n = f.nc.page.maxw;
                    (f.speedx = 0 < n ? Math.min(60, f.speedx) : 0),
                        (f.speedy = 0 < s ? Math.min(60, f.speedy) : 0);
                    var l = t && o - t <= 60;
                    (i < 0 || s < i || r < 0 || n < r) && (l = !1);
                    ...
                    if (a || c) {
                        ...
                        (f.demulxy = 0),
                            (f.lastscrollx = f.nc.getScrollLeft()),
                            (f.chkx = f.lastscrollx),
                            (f.lastscrolly = f.nc.getScrollTop()),
                            (f.chky = f.lastscrolly);
                        var h = f.lastscrollx,
                            p = f.lastscrolly,
                            m = function () {
                                ...
                                f.speedx &&
                                    ((h = Math.floor(
                                        f.lastscrollx -
                                            f.speedx * (1 - f.demulxy)
                                    )),
                                    ((f.lastscrollx = h) < 0 || n < h) &&
                                        (e = 0.1)),
                                    f.speedy &&
                                        ((p = Math.floor(
                                            f.lastscrolly -
                                                f.speedy * (1 - f.demulxy)
                                        )),
                                        ((f.lastscrolly = p) < 0 || s < p) &&
                                            (e = 0.1)),
    ...
    (e.cssHooks.pageYOffset = {
        ...
        set: function (e, o) {
            ...
            return (
                t && t.ishwscroll ? t.setScrollTop(parseInt(o)) : i.call(e, o),
                this
            );
        },
    }),
    ...
    (P.cssHooks.pageXOffset = {
        ...
        set: function (e, o) {
            var t = P.data(e, "__nicescroll") || !1;
            return (
                t && t.ishwscroll ? t.setScrollLeft(parseInt(o)) : n.call(e, o),
                this
            );
        },
    }),
    ...
    !(function (e, o, t) {
        ...
        (e.fn.getNiceScroll = function (e) {
            return void 0 === e
                ? new a(this)
                : (this[e] && P.data(this[e], "__nicescroll")) || !1;
        }),
