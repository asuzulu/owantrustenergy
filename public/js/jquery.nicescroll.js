...
(function (factory) {
    ...
    var getBrowserDetection = function () {
        ...
        d.isoperamini =
            Object.prototype.toString.call(_win.operamini) ===
            "[object OperaMini]";
    ...
    var NiceScrollClass = function (myopt, me) {
        ...
        if (this.ishwscroll) {
            ...
            this.getScrollLeft = function () {
                ...
                if (!self.hasreversehr) {
                    ...
                    val =
                        self.page.maxw - Math.abs(self.docscroll.scrollLeft());
                } else {
            ...
            if (!self.ispage || !cap.isieold) {
                ...
                if (opt.boxzoom && !self.ispage && !cap.isieold) {
                    ...
                    self.zoom.css({
                        ...
                        zIndex: self.zindex,
                        backgroundImage:
                            "url(" + opt.scriptpath + "zoomico.png)",
                        height: 18,
                        width: 18,
                ...
                if (
                    ...
                    self.ontouchstart = function (e) {
                        ...
                        if (!self.railslocked) {
                            ...
                            if (tg) {
                                var skp =
                                    /INPUT/i.test(tg.nodeName) &&
                                    /range/i.test(tg.type);
                            ...
                            if (tg && ismouse) {
                                var ip = /INPUT|SELECT|BUTTON|TEXTAREA/i.test(
                                    tg.nodeName
                                );
                                if (!ip) {
                        ...
                        if (self.rail.drag.pt == 2) {
                            ...
                            if (self.ishwscroll && opt.bouncescroll) {
                                if (ny < 0) {
                                    ...
                                    ny =
                                        self.page.maxh +
                                        Math.round((ny - self.page.maxh) / 2);
                                }
                            } else {
                                if (ny < 0) {
                                    ny = 0;
                            ...
                            if (!self.hasmoving) {
                                ...
                                if (!self.rail.drag.ck) {
                                    if (ay > dz && ax > dz)
                                        ...
                                        self.rail.drag.dl =
                                            ax > locktollerance ? "f" : "v";
                                    else if (ax > dz)
                                        self.rail.drag.dl =
                                            ay > locktollerance ? "f" : "h";
                    ...
                    self.ontouchstartCursor = function (e, hronly) {
                        ...
                        if (self.isiframe && !cap.hasmousecapture) {
                            self.saved.csspointerevents =
                                self.doc.css("pointer-events");
                    ...
                    self.ontouchmoveCursor = function (e) {
                        if (self.rail.drag) {
                            ...
                            if (self.rail.drag.hr) {
                                self.scroll.x =
                                    self.rail.drag.sx +
                                    (e.touches[0].clientX - self.rail.drag.x);
                                ...
                                self.scroll.y =
                                    self.rail.drag.sy +
                                    (e.touches[0].clientY - self.rail.drag.y);
                        ...
                        self.synched("mousemove", function () {
                            if (self.cursorfreezed) {
                                ...
                                if (self.rail.drag.hr) {
                                    self.scrollLeft(
                                        Math.round(
                                            self.scroll.x * self.scrollratio.x
                                        )
                                    );
                                } else {
                                    self.scrollTop(
                                        Math.round(
                                            self.scroll.y * self.scrollratio.y
                                        )
                                    );
                                }
                            }
              ...
              */
                ...
                if (
                    opt.cursordragontouch ||
                    (!cap.cantouch && !opt.emulatetouch)
                ) {
                    self.rail.css({
                        cursor: "default",
                    });
                ...
                if (
                    opt.cursordragontouch &&
                    (this.istouchcapable || cap.cantouch)
                ) {
                    self.bind(
                        self.cursor,
                        "touchstart",
                        self.ontouchstartCursor
                    );
                    ...
                    self.cursorh &&
                        self.bind(
                            self.cursorh,
                            "touchmove",
                            self.ontouchmoveCursor
                        );
                    self.cursorh &&
                        self.bind(
                            self.cursorh,
                            "touchend",
                            self.ontouchendCursor
                        );
                }
                ...
                if (
                    ...
                    self.bind(self.win, "focus", function (e) {
                        ...
                        domfocus =
                            self.getTarget(e).id || self.getTarget(e) || false;
                        self.hasfocus = true;
                ...
                self.onkeypress = function (e) {
                    ...
                    if (
                        tg &&
                        /INPUT|TEXTAREA|SELECT|OPTION/.test(tg.nodeName)
                    ) {
                ...
                if (opt.enableobserver) {
                    if (!self.isie11 && ClsMutationObserver !== false) {
                        // IE11 crashes  #568
                        self.observerbody = new ClsMutationObserver(function (
                            mutations
                        ) {
                    ...
                    if (!self.ispage && !self.haswrapper) {
                        ...
                        if (ClsMutationObserver !== false) {
                            self.observer = new ClsMutationObserver(function (
                                mutations
                            ) {
                            ...
                            self.observerremover = new ClsMutationObserver(
                                function (mutations) {
            ...
            self._bind(
                ...
                function (e) {
                    ...
                    if (name == "mousewheel") {
                        ...
                        e.wheelDeltaY &&
                            (event.deltaY = (-1 / 40) * e.wheelDeltaY);
                        !event.deltaY &&
                            !event.deltaX &&
        ...
        this.mousewheel = function (dom, fn, bubble) {
            ...
            if ("onwheel" in _doc.createElement("div")) {
                ...
                var wname =
                    _doc.onmousewheel !== undefined
                        ? "mousewheel"
                        : "DOMMouseScroll"; // older Webkit+IE support or older Firefox
        ...
        if (!opt.smoothscroll) {
            ...
            this.prepareTransition = function (dif, istime) {
                ...
                if (lasttransitionstyle !== trans) {
                    ...
                    self.doc.css(
                        cap.prefixstyle + "transition-duration",
                        trans
                    );
                }
                return ex;
            ...
            this.doScrollPos = function (x, y, spd) {
                ...
                if (!cap.transitionend) {
                    ...
                    self.scrollendtrapped = setTimeout(
                        self.onScrollTransitionEnd,
                        ms
            ...
            this.doScrollPos = function (x, y, spd) {
                ...
                var dd =
                    Math.sqrt(
                        self.dst.x * self.dst.x + self.dst.y * self.dst.y
                    ) | 0;
                ...
                self.bzscroll.x = new BezierClass(
                    px,
                    self.newscrollx,
                    ms,
                    0,
                ...
                self.bzscroll.y = new BezierClass(
                    py,
                    self.newscrolly,
                    ms,
                    0,
        ...
        self.onscroll = function (e) {
            ...
            if (!self.cursorfreezed) {
                self.synched("scroll", function () {
                    self.scroll.y = Math.round(
                        self.getScrollTop() / self.scrollratio.y
                    );
                    if (self.railh)
    ...
    jQuery.fn.scrollTop = function (value) {
        if (value === undefined) {
            var nice = this[0]
                ? $.data(this[0], "__nicescroll") || false
                : false;
            return nice && nice.ishwscroll
                ? nice.getScrollTop()
    ...
    jQuery.fn.getNiceScroll = function (index) {
        if (index === undefined) {
            ...
            return (
                (this[index] && $.data(this[index], "__nicescroll")) || false
            );
        }
    };
