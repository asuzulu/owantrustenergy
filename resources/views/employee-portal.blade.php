...
@section('title', 'Employee Portal Login - Owan Trust Energy')

@section('content')
<!-- Employee Portal Login form section start -->
<h1 class="about_text text-center" style="margin-top: 6rem;">Employee Portal Login</h1>
...
<!-- Employee Portal Login form section end -->
@endsection
