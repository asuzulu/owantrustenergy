...
@section('content')
                    ...
                    @if (Auth::user()->position !== 'Agent')
                        <div class="col-md-10 col-sm-12">
                            <div
                                ...
                                <a href="#" class="btn btn-primary mb-2 mx-2" data-toggle="modal"
    ...
    <style>
        /* Hide some page links on small screens */
        .pagination li.page-item {
            display: inline-block;
        }

        /* Tablet & below (≤992px): show only Prev + 1,2,3 + Next */
        @media (max-width: 992px) {
            .pagination li.page-item:nth-child(n+6):not(:last-child) {
                display: none;
            }
        }

        /* Mobile (≤576px): show only Prev, Current, Next
       & make the wrapper fixed at bottom-center */
        @media (max-width: 576px) {
            ...
            /* …then re-show Prev, the active page, and Next */
            ...
            /* Fix the pagination container to bottom-center */
