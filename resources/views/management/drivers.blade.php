...
@extends(
    ...
    (Auth::user()->position === 'Driver' ? 'layouts.drivers-dashboard' : 'layouts.default-dashboard'))
)
                ...
                <div class="row">
                    ...
                    @if (Auth::user()->position !== 'Driver')
                        <div class="col-md-4 col-sm-12 text-right">
                            <button class="btn btn-small btn-primary" data-toggle="modal" data-target="#addDriverModal">Add New Driver</button>
                        </div>
                    @endif
                </div>
                    ...
                    <table class="table table-hover table-striped tm-table-striped-even mt-3">
                        ...
                        <tbody>
                            @foreach ($drivers as $driver)
                                <tr onclick="window.location='{{ route('drivers.profile', $driver->id) }}'" style="cursor: pointer;">
