        ...
        <div class="navbar-nav">
            ...
            @if (Auth::check())
                @if(Auth::user()->position === 'Customer')
                    <a class="nav-item nav-link {{ request()->routeIs('dashboard.profile') ? 'active' : '' }}" href="{{ route('dashboard.profile') }}">Dashboard</a>
                @elseif(Auth::user()->position === 'Manager')
                    <a class="nav-item nav-link {{ request()->routeIs('management.home') ? 'active' : '' }}" href="{{ route('management.home') }}">Dashboard</a>
                ...
                @endif
                <a class="nav-item nav-link {{ request()->routeIs('dashboard.profile') ? 'active' : '' }}" href="{{ route('dashboard.profile') }}">{{ Auth::user()->full_name }}</a>
